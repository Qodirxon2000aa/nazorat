                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3.5 py-2 text-xs bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl focus:outline-none focus:border-emerald-500/50 text-slate-900 dark:text-white placeholder-slate-500"
                      />
                    </div>
