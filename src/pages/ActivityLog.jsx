      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-xs bg-[#121214] border border-white/10 focus:border-emerald-500/50 rounded-full text-white placeholder-slate-500 focus:outline-none"
          />
        </div>
      </div>
              ...
              <tbody className="divide-y divide-white/5 font-medium text-slate-200">
                {filteredLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-5 py-3.5">
                      <span className="inline-flex items-center gap-1.5 font-bold text-white px-2.5 py-1 bg-white/5 border border-white/10 rounded-xl">
