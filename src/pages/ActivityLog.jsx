      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
            <History className="w-7 h-7 sm:w-8 sm:h-8 text-blue-700 dark:text-blue-400" />
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-xs bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-700 focus:border-blue-500/50 rounded-full text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none"
          />
        </div>
      </div>
                  ...
                  <tr key={log.id} className="hover:bg-slate-100 dark:bg-white/5 transition-colors">
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-2.5">
                        <div className="p-2 rounded-xl bg-blue-500/10 text-blue-700 dark:text-blue-400 border border-blue-500/20">
                    ...
                    <td className="px-5 py-3.5">
                      <span className="inline-flex items-center gap-1.5 font-bold text-slate-900 dark:text-white px-2.5 py-1 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-slate-700 rounded-xl">
                    ...
                    <td className="px-5 py-3.5 text-slate-700 dark:text-slate-300 font-bold">
                      <span className="inline-flex items-center gap-1">
                        <Clock className="w-3.5 h-3.5 text-slate-700 font-bold" />
                        {new Date(log.timestamp).toLocaleString()}
                      </span>
                    </td>

                    <td className="px-5 py-3.5 text-slate-700 dark:text-slate-300 font-bold font-mono text-[11px]">
                      <span className="inline-flex items-center gap-1">
                        <Laptop className="w-3 h-3 text-slate-700 font-bold" />
