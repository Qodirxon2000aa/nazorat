              ...
              <div>
                ...
                <div className="space-y-2 py-3 border-y border-slate-200 dark:border-white/5 my-3 text-xs">
                  ...
                  <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
                    ...
                    <span className="font-bold text-blue-400 bg-blue-500/10 border border-blue-500/20 px-2 py-0.5 rounded-md">
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="p-2 text-blue-400 hover:bg-blue-500/10 rounded-xl transition-colors text-xs font-bold"
