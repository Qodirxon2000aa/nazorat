        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              >
                <option value="Filial" className="bg-white dark:bg-[#0f172a] text-slate-900 dark:text-white">Filial</option>
                <option value="Zavod" className="bg-white dark:bg-[#0f172a] text-slate-900 dark:text-white">Zavod</option>
              </select>
            </div>
