        ...
        <div className="flex flex-wrap items-center gap-4 pt-3 border-t border-white/10">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3.5 py-2 text-xs bg-white/5 border border-white/10 rounded-xl text-white font-medium focus:outline-none"
            >
      ...
      {loading || !statsData ? (
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-emerald-950/40 border border-emerald-500/20 text-white shadow-xl">
            ...
            <div className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-rose-950/40 border border-rose-500/20 text-white shadow-xl">
              <div className="flex items-center justify-between mb-2">
            ...
            <div className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-cyan-950/40 border border-cyan-500/20 text-white shadow-xl">
              <div className="flex items-center justify-between mb-2">
            ...
            <div className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-amber-950/40 border border-amber-500/20 text-white shadow-xl">
              <div className="flex items-center justify-between mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#121214] border border-white/5 shadow-xl">
            ...
            <div className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#121214] border border-white/5 shadow-xl flex flex-col items-center justify-between">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Top 10 Employees */}
            <div className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#121214] border border-white/5 shadow-xl">
          ...
          <div className="p-5 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#121214] border border-emerald-500/20 shadow-2xl space-y-4">
              ...
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-white/5 font-medium text-slate-200">
                  {(statsData?.cumulativePointsLeaderboard || []).map((emp, index) => (
                    <tr key={emp.id || index} className="hover:bg-white/5 transition-colors">
